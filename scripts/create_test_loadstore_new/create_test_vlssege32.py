...
def create_empty_test_vlssege32(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    generate_macros_load_vx_Nregs(f, 32, 16); # for vlsseg2e8

    # Generate tests
    generate_tests(f, vsew, lmul)

    print_load_ending_new(f, 32, 16, is_vx = True)
