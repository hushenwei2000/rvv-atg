...
def create_empty_test_vsmul(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("  TEST_AVG_VV_OP( 1,  vsmul.vv, 0x0, 0x0, 0x0000, 0x000, 0x00, 0x00 );", file=f)
...
def create_first_test_vsmul(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
