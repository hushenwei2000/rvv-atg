...
def create_empty_test_vmsleu(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("TEST_VVM_OP( 1, vmsleu.vv, 0x5201314, 1, 1 );", file=f)
...
def create_first_test_vmsleu(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
