...
def create_empty_test_vnsrl(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("  TEST_N_VV_OP( 1, vnsrl.wv, 2, 1, 1 );", file=f)
...
def create_first_test_vnsrl(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
