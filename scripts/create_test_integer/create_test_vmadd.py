...
def create_empty_test_vmadd(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("  TEST_VV_OP_WITH_INIT( 1, vmadd.vv, 2, 1, 1 );", file=f)
...
def create_first_test_vmadd(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
