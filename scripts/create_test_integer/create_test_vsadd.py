...
def create_empty_test_vsadd(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("  TEST_VV_OP( 1, vsadd.vv, 2, 1, 1 );", file=f)
...
def create_first_test_vsadd(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
