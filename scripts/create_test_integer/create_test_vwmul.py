...
def create_empty_test_vwmul(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("  TEST_W_VV_OP( 1, vwmul.vv, 2, 1, 1 );", file=f)
...
def create_first_test_vwmul(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
