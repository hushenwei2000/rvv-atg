...
def create_empty_test_vzext(xlen, vlen, vsew, lmul, vta, vma, output_dir):
...
def create_first_test_vzext(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
    ...
    generate_macros_ext_op(f, lmul)

    # Generate tests
    num_tests_tuple = generate_tests_ext_op(instr, f, rs1_val, rs2_val, lmul)
