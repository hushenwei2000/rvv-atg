...
def create_empty_test_vredmax(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("  TEST_VV_OP( 1, vredmax.vs, 2, 1, 1 );", file=f)
...
def create_first_test_vredmax(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
