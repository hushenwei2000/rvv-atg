...
def create_empty_test_vnmsub(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("  TEST_VX_OP_RV( 1, vnmsub.vx, 2, 1, 1 );", file=f)
...
def create_first_test_vnmsub(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
