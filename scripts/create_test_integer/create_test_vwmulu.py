...
def create_empty_test_vwmulu(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("  TEST_W_VV_OP( 1, vwmulu.vv, 2, 1, 1 );", file=f)
...
def create_first_test_vwmulu(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
