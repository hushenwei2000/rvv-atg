...
def generate_macros(f):
    for n in range(2, 32):
        print("#define TEST_VVM_OP_1%d( testnum, inst, result, val1, val2 ) "%n + " \\\n\
    ...
    for n in range(3, 32):
        print("#define TEST_VVM_OP_rd%d( testnum, inst, result, val1, val2 ) "%n + " \\\n\
    ...
    print("#define TEST_VVM_OP_rd1( testnum, inst, result, val1, val2 ) \\\n\
    ...
    print("#define TEST_VVM_OP_rd2( testnum, inst, result, val1, val2 ) \\\n\
...
def create_empty_test_vmseq(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("  TEST_VVM_OP( 1, vmseq.vv, 2, 1, 1 );", file=f)
...
def create_first_test_vmseq(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
