...
def generate_macros(f):
    for n in range(2, 32):
        print("#define TEST_ADC_VV_OP_1%d( testnum, inst, result, val2, val1 )"%n + " \\\n\
    ...
    print("#define TEST_ADC_VV_OP_rd1( testnum, inst, result, val1, val2 ) \\\n\
    ...
    print("#define TEST_ADC_VV_OP_rd2( testnum, inst, result, val1, val2 ) \\\n\
