...
def generate_tests(f, rs1_val, rs2_val, lmul, vsew):
    ...
    if vsew == 8:
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 101, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 10, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 12, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 3, -86);", file=f)
    elif vsew == 16:
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 26213, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 180, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 182, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 3, -21846);", file=f)
    elif vsew == 32:
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 1717986917, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 46339, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 46341, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 3, -1431655766);", file=f)
    elif vsew == 64:
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 7378697629483820645, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 3037000498, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 3037000500, 3);", file=f)
        n += 1
        print("  TEST_ADC_VV_OP( "+str(n)+",  %s.vvm"%instr + ", 5201314, 3, -6148914691236517206);", file=f)
...
def create_empty_test_vsbc(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("  TEST_ADC_VV_OP( 1, vsbc.vvm, 2, 1, 1 );", file=f)
