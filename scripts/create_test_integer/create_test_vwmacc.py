...
def create_empty_test_vwmacc(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print("  TEST_W_VX_OP_RV( 1, vwmacc.vx, 2, 1, 1 );", file=f)
...
def create_first_test_vwmacc(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
