...
def create_empty_test_vsuxei32(xlen, vlen, vsew, lmul, vta, vma, output_dir):
...
def create_first_test_vsuxei32(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
    ...
    generate_macros_vsuxei(f, lmul, vsew, 32)
