...
def generate_tests(f, rs1_val, rs2_val, vsew, lmul):
    ...
    for i in range(100):     
        k = i%30+1
        if k != 8 and k != 16 and k % lmul == 0 and k % 4 == 0 and k!= 12 and k != 20 and k !=24 and k!= 29 and k != 30:
            n+=1
...
def create_empty_test_vs4r(xlen, vlen, vsew, lmul, vta, vma, output_dir):
...
def create_first_test_vs4r(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
