...
def generate_tests(f, rs1_val, rs2_val):
    ...
    for i in range(2):
        n += 1
        print("  TEST_VLRE1_OP( "+str(n)+",  %s.v, " %instr+" 32 "+", "+"0x00ff00ff"+", "+"0 + tdat"+" );", file=f)
        n += 1
        print("  TEST_VLRE2_OP( "+str(n)+",  %s.v, " %instr1+" 32 "+", "+"0x00ff00ff"+", "+"0x00ff00ff"+", "+"-12 + tdat4"+" );", file=f)
        n += 1
        print("  TEST_VLRE2_OP( "+str(n)+",  %s.v, " %instr2+" 32 "+", "+"0x00ff00ff"+", "+"0x00ff00ff"+",  "+"-12 + tdat4"+" );", file=f)
        n += 1
        print("  TEST_VLRE2_OP( "+str(n)+",  %s.v, " %instr3+" 32 "+", "+"0x00ff00ff"+", "+"0x00ff00ff"+",  "+"-12 + tdat4"+" );", file=f)
...
def create_empty_test_vlre32(xlen, vlen, vsew, lmul, vta, vma, output_dir):
    ...
    print(" TEST_VLRE1_OP(11, vl1re32.v, 32, 0x00ff00ff, 0  + tdat );", file=f)
