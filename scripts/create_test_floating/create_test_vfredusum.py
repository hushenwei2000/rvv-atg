...
def create_empty_test_vfredusum_b1(xlen, vlen, vsew, lmul, vta, vma, output_dir):
...
def create_first_test_vfredusum_b1(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
