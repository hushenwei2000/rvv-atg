...
def create_empty_test_vfsgnjn_b1(xlen, vlen, vsew, lmul, vta, vma, output_dir):
...
def create_first_test_vfsgnjn_b1(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
