...
def generate_macros(f):
    for n in range(2,32):
        print("#define TEST_FP_VV_OP_1%d( testnum, inst, flags, result, val1, val2 )"%n + " \\\n\
    ...
    for n in range(3,32):
        print("#define TEST_FP_VV_OP_rd%d( testnum, inst, flags, result, val1, val2 )"%n + " \\\n\
    ...
    print("#define TEST_FP_VV_OP_rd1( testnum, inst, flags, result, val1, val2 ) \\\n\
    ...
    print("#define TEST_FP_VV_OP_rd2( testnum, inst, flags, result, val1, val2 ) \\\n\
        TEST_CASE_FP( testnum, v2, flags, result, val1, val2, \\\n\
            flw f0, 0(a0); \\\n\
            flw f1, 4(a0); \\\n\
            vfmv.s.f v3, f0; \\\n\
            vfmv.s.f v1, f1; \\\n\
...
def create_empty_test_vfredosum_b1(xlen, vlen, vsew, lmul, vta, vma, output_dir):
...
def create_first_test_vfredosum_b1(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
