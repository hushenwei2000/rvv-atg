...
def generate_tests(f, rs1_val, rs2_val):    
    n = 1
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.xu.f.v (float to unsigned integer) tests",file=f)
    print("  #-------------------------------------------------------------",file=f)
    ...
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.x.f.v (float to signed integer) tests",file=f)
    print("  #-------------------------------------------------------------",file=f)
    print("  RVTEST_SIGBASE( x12,signature_x12_1)",file=f)
    for i in range(len(rs1_val)):
    ...
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.rtz.xu.f.v (float to signed integer truncating) tests",file=f)
    print("  #-------------------------------------------------------------",file=f)
    print("  RVTEST_SIGBASE( x12,signature_x12_1)",file=f)
    for i in range(len(rs1_val)):
    ...
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.rtz.x.f.v (float to signed integer truncating) tests",file=f)
    print("  #-------------------------------------------------------------",file=f)
    print("  RVTEST_SIGBASE( x12,signature_x12_1)",file=f)
    for i in range(len(rs1_val)):
    ...
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.f.xu.v (unsigned integer to float) tests",file=f)
    print("  #-------------------------------------------------------------",file=f)
    print("  RVTEST_SIGBASE( x12,signature_x12_1)",file=f)
    for i in range(len(rs1_val)):
    ...
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.f.x.v (signed integer to float) tests",file=f)
    print("  #-------------------------------------------------------------",file=f)
    print("  RVTEST_SIGBASE( x12,signature_x12_1)",file=f)
    for i in range(len(rs1_val)):        
    ...
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.xu.f.v (float to unsigned integer) tests (different register)",file=f)
    print("  #-------------------------------------------------------------",file=f)
    print("  RVTEST_SIGBASE( x12,signature_x12_1)",file=f)
    n = n+1
    for i in range(len(rs1_val)):     
    ...
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.x.f.v (float to signed integer) tests (different register)",file=f)
    print("  #-------------------------------------------------------------",file=f)
    print("  RVTEST_SIGBASE( x12,signature_x12_1)",file=f)
    n = n+1
    for i in range(len(rs1_val)):     
    ...
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.rtz.xu.f.v (float to unsigned integer truncating) tests (different register)",file=f)
    print("  #-------------------------------------------------------------",file=f)
    print("  RVTEST_SIGBASE( x12,signature_x12_1)",file=f)
    n = n+1
    for i in range(len(rs1_val)):     
    ...
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.rtz.x.f.v (float to signed integer truncating) tests (different register)",file=f)
    print("  #-------------------------------------------------------------",file=f)
    print("  RVTEST_SIGBASE( x12,signature_x12_1)",file=f)
    n = n+1
    for i in range(len(rs1_val)):     
    ...
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.f.xu.v (unsigned integer to float) tests (different register)",file=f)
    print("  #-------------------------------------------------------------",file=f)
    print("  RVTEST_SIGBASE( x12,signature_x12_1)",file=f)
    n = n+1
    for i in range(len(rs1_val)):     
    ...
    print("  #-------------------------------------------------------------",file=f)
    print("  # vfncvt.f.x.v (signed integer to float) tests (different register)",file=f)
    print("  #-------------------------------------------------------------",file=f)
    print("  RVTEST_SIGBASE( x12,signature_x12_1)",file=f)
    n = n+1
    for i in range(len(rs1_val)):     
