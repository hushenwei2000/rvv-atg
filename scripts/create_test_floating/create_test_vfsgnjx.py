...
def create_empty_test_vfsgnjx_b1(xlen, vlen, vsew, lmul, vta, vma, output_dir):
...
def create_first_test_vfsgnjx_b1(xlen, vlen, vsew, lmul, vta, vma, output_dir, rpt_path):
