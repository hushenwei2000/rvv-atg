...
#define RVTEST_VSET RVTEST_VECTOR_ENABLE; vsetivli x31, 1, e8, tu, mu;
...
#define VSET_VSEW vsetivli x31, 1, e8, tu, mu;
#define VSET_VSEW_4AVL vsetvli x31, x0, e8, tu, mu;
#define VSET_DOUBLE_VSEW vsetivli x31, 1, e16, tu, mu;
#define VSET_DOUBLE_VSEW_4AVL vsetvli x31, x0, e16, m2, tu, mu;
...
#define TEST_VFMVF_OP( testnum, base ) \
 ...
 #define TEST_CASE_LOOP_LOADRESULT32(testnum, inst, flags, result_base, rd_base, f_rs1_base, base ) \
