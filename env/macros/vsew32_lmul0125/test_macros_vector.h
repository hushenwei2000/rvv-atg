...
#define RVTEST_VSET RVTEST_VECTOR_ENABLE; vsetivli x31, 1, e32, mf8, tu, mu;
...
#define VSET_VSEW vsetivli x31, 1, e32, mf8, tu, mu;
#define VSET_VSEW_4AVL vsetvli x31, x0, e32, mf8, tu, mu;
#define VSET_DOUBLE_VSEW vsetivli x31, 1, e64, mf8, tu, mu;
#define VSET_CONST_VSEW(eew_num) vsetivli x31, ##eew_num, mf8, tu, mu;
#define VSET_DOUBLE_VSEW_4AVL vsetvli x31, x0, e64, mf4, tu, mu;
