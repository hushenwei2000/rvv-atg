...
#define RVTEST_VSET RVTEST_VECTOR_ENABLE; vsetivli x31, 1, e8, m2, tu, mu;
...
#define VSET_VSEW vsetivli x31, 1, e8, m2, tu, mu;
#define VSET_VSEW_4AVL vsetvli x31, x0, e8, m2, tu, mu;
#define VSET_DOUBLE_VSEW vsetivli x31, 1, e16, m2, tu, mu;
#define VSET_CONST_VSEW(eew_num) vsetivli x31, ##eew_num, m2, tu, mu;
#define VSET_DOUBLE_VSEW_4AVL vsetvli x31, x0, e16, m4, tu, mu;
...
test_ ## testnum: \
    ...
    csrr x31, vstart; \
    csrr x30, vl; \
    vle8.v v15, (correctval_addr_reg); \
    li TESTNUM, testnum; \
