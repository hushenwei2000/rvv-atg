...
// VSEW temporarily hard-coded to 64 bits
#define TESTNUM gp
...
#define RVTEST_VSET RVTEST_VECTOR_ENABLE; vsetivli x31, 1, e64, mf4, tu, mu;
...
#define VSET_VSEW vsetivli x31, 1, e64, mf4, tu, mu;
#define VSET_VSEW_4AVL vsetvli x31, x0, e64, mf4, tu, mu;
#define VSET_DOUBLE_VSEW vsetivli x31, 1, e64, mf4, tu, mu;
...
#define TEST_CASE_LOOP_CONTINUE( testnum, testreg, correctval_addr_reg, code...) \
    ...
    csrr x31, vstart; \
    csrr x30, vl; \
    vle64.v v8, (correctval_addr_reg); \
    li TESTNUM, testnum; \
1:  VMVXS_AND_MASK_VSEW( x14, testreg ) \
    VMVXS_AND_MASK_VSEW( x7, v8 ) \
    VECTOR_RVTEST_SIGUPD(x20, testreg); \
