...
#define RVTEST_VSET RVTEST_VECTOR_ENABLE; vsetivli x31, 1, e16, m2, tu, mu;
#define __riscv_vsew 16
#define __e_riscv_vsew e16
...
#define VSET_VSEW vsetivli x31, 1, e16, m2, tu, mu;
#define VSET_VSEW_4AVL vsetvli x31, x0, e16, m2, tu, mu;
#define VSET_DOUBLE_VSEW vsetivli x31, 1, e32, m2, tu, mu;
#define VSET_CONST_VSEW(eew_num) vsetivli x31, ##eew_num, m2, tu, mu;
#define VSET_DOUBLE_VSEW_4AVL vsetvli x31, x0, e32, m4, tu, mu;
...
test_ ## testnum: \
    ...
    li TESTNUM, testnum; \
    vsetivli x31, 1, MK_EEW(eew), m2, tu, mu; \
    VMVXS_AND_MASK_EEW( x14, testreg, eew ) \
    VSET_VSEW \
    VECTOR_RVTEST_SIGUPD(x20, testreg); \
    vsetivli x31, 4, MK_EEW(eew), m2, tu, mu; \
...
test_ ## testnum: \
    ...
    VSET_VSEW \
    VECTOR_RVTEST_SIGUPD(x20, testreg); \
    VECTOR_RVTEST_SIGUPD(x24, v9); \
    VECTOR_RVTEST_SIGUPD(x12, v10); \
...
#define TEST_CASE_LOOP_W( testnum, testreg, correctval_addr_reg, code...) \
test_ ## testnum: \
    code; \
    la x7, correctval_addr_reg; \
    vle32.v v8, (x7); \
...
#define TEST_CASE_LOOP_CONTINUE( testnum, testreg, correctval_addr_reg, code...) \
    ...
    csrr x31, vstart; \
    csrr x30, vl; \
    vle16.v v8, (correctval_addr_reg); \
    li TESTNUM, testnum; \
1:  VMVXS_AND_MASK_VSEW( x14, testreg ) \
    VMVXS_AND_MASK_VSEW( x7, v8 ) \
    VECTOR_RVTEST_SIGUPD(x20, testreg); \
...
test_ ## testnum: \
    ...
    csrr x31, vstart; \
    csrr x30, vl; \
    vle16.v v15, (correctval_addr_reg); \
    li TESTNUM, testnum; \
...
test_ ## testnum: \
  ...
  li TESTNUM, testnum; \
  vsetivli x31, 1, MK_EEW(correctval_eew), m2, tu, mu; \
...
#define TEST_AVG_VI_OP( testnum, inst, result00, result01, result10, result11, val1, val2 ) \
  TEST_CASE_AVG_VI( testnum, inst, v16, result00, result01, result10, result11, val2, \
    li x7, MASK_VSEW(val1); \
    vmv.v.x v8, x7; \
  )
...
#define TEST_W_FP_1OPERAND_OP( testnum, inst, flags, result, val ) \
  TEST_W_CASE_FP( testnum, v24, flags, result, val, 0, \
    flw f0, 0(a0); \
    vfmv.s.f v8, f0; \
    fld f2, 8(a0); \
    inst v24, v8; \
...
#define TEST_W_FP_VV_OP( testnum, inst, finst, flags, val1, val2 ) \
  TEST_CASE_W_FP( testnum, v24, flags, val1, val2,     \
    flw f0, 0(a0); \
    flw f1, 4(a0); \
    vfmv.s.f v8, f0; \
    vfmv.s.f v16, f1; \
...
#define TEST_W_FP_INT_OP( testnum, inst, flags, result, val ) \
  TEST_CASE_FP_INT( testnum, v24, flags, __riscv_double_vsew, result, val,   \
    flw f0, 0(a0); \
    vfmv.s.f v8, f0; \
    inst v24, v8; \
  )
