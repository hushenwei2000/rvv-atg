...
#define RVTEST_VSET RVTEST_VECTOR_ENABLE; vsetivli  x31, 1, e16, m8, tu, mu;
...
#define VSET_VSEW vsetivli x31, 1, e16, m8, tu, mu;
#define VSET_VSEW_4AVL vsetvli x31, x0, e16, m8, tu, mu;
#define VSET_DOUBLE_VSEW vsetivli x31, 1, e32, m8, tu, mu;
#define VSET_CONST_VSEW(eew_num) vsetivli x31, ##eew_num, m8, tu, mu;
#define VSET_DOUBLE_VSEW_4AVL vsetvli x31, x0, e32, m8, tu, mu;
...
test_ ## testnum: \
    ...
    li TESTNUM, testnum; \
    vsetivli x31, 1, MK_EEW(eew), m8, tu, mu; \
    VMVXS_AND_MASK_EEW( x14, testreg, eew ) \
    VSET_VSEW \
    VECTOR_RVTEST_SIGUPD(x20, testreg); \
    vsetivli x31, 4, MK_EEW(eew), m8, tu, mu; \
...
test_ ## testnum: \
  ...
  li TESTNUM, testnum; \
  vsetivli x31, 1, MK_EEW(correctval_eew), m8, tu, mu; \
